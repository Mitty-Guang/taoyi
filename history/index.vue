  ...
  <el-container>
    ...
    <el-main style="height: calc(100vh - 60px)">
      ...
      <div class="index-hot-news">
        <div>
          <div class="index-title">热门新闻</div>
          <div
            class="index-content-with-img"
            style="box-shadow: darkgrey 0px 0px 30px 5px"
            @click="news1"
          >
            <div>
              <img
                src="https://gulimall-nkhyx.oss-cn-beijing.aliyuncs.com/news/20220406-3.png"
              />
            </div>
            <div class="index-content-image-news">
              <div class="title">陶瓷匠刘志钧：用心一把泥 凡土化神奇</div>
              <div class="content">
                <p class="p1">
          ...
          <div>
            ...
            >
              <div>
                <img
                  src="https://gulimall-nkhyx.oss-cn-beijing.aliyuncs.com/news/20220426.png"
                />
              </div>
              <div class="index-content-image-news">
                <div class="title">古陶瓷生产的活化石</div>
                <div class="content">
                  <p class="p1">
          ...
          <div>
            ...
            >
              <div>
                <img
                  src="https://gulimall-nkhyx.oss-cn-beijing.aliyuncs.com/news/20220618-1.png"
                />
              </div>
              <div class="index-content-image-news">
                <div class="title">感受非遗文化，传承陶瓷艺术</div>
                <div class="content">
                  <p class="p1">
        ...
        <div>
          <div class="index-title">更多热门新闻</div>
          <div class="index-content" @click="news4">
            <div class="index-content-news">
              <div class="title">两代陶瓷人 同一“陶瓷梦”</div>
              <div class="content">
                <p class="p1">
          ...
          <div>
            <div class="index-content" @click="news5">
              <div class="index-content-news">
                <div class="title">景德镇：让陶瓷产业插上“数字翅膀”</div>
                <div class="content">
                  <p class="p1">
          ...
          <div>
            <div class="index-content" @click="news6">
              <div class="index-content-news">
                <div class="title">景德镇成立首个古陶瓷基因库</div>
                <div class="content">
                  <p class="p1">
                    本报南昌6月13日电
      ...
      <div class="index-footer">
        <div class="footer-logo">
          <div style="margin-top: 20px">
            <img
              src="../assets/images/taoci_origin.png"
              style="height: 60px; margin-left: 60px"
            />
          </div>
        </div>
...
.index-forum {
  ...
  border-radius: 5px;
  background: url(https://gulimall-nkhyx.oss-cn-beijing.aliyuncs.com/index/佳作欣赏.png)
    no-repeat;
...
export default {
  data() {
    return {
      ...
      imgwrap: [
        {
          url: "https://gulimall-nkhyx.oss-cn-beijing.aliyuncs.com/taoyi/img1.jpg",
        },
        {
          url: "https://gulimall-nkhyx.oss-cn-beijing.aliyuncs.com/taoyi/img2.jpg",
        },
        {
          url: "https://gulimall-nkhyx.oss-cn-beijing.aliyuncs.com/taoyi/img3.jpg",
        },
        {
          url: "https://gulimall-nkhyx.oss-cn-beijing.aliyuncs.com/taoyi/img4.jpg",
        },
      ],
      srcList: [
