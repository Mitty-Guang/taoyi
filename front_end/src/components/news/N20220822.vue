  ...
  <el-main class="news">
    ...
    <div class="news-main">
      <div class="news-article">
        ...
        <div class="news-text">
          <img src="https://gulimall-nkhyx.oss-cn-beijing.aliyuncs.com/news/20220822.png" alt="" />
          <p>
            8月20日，观众在内蒙古美术馆参观陶艺作品。近日，黑龙江省柴烧陶艺交流展在内蒙古美术馆展出，共有64件体现黑龙江省鲜明地域特色的陶瓷作品应邀参展。此次活动旨在进一步深化省（区）交往交流交融，助力两地文化事业共同发展。
          </p>
        </div>
